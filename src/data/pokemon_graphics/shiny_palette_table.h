const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_PAL(SPRIGATITO, gMonShinyPalette_Sprigatito),
    SPECIES_PAL(FLORAGATO, gMonShinyPalette_Floragato),
    SPECIES_PAL(MEOWSCARADA, gMonShinyPalette_Meowscarada),
    SPECIES_PAL(FUECOCO, gMonShinyPalette_Fuecoco),
    SPECIES_PAL(CROCALOR, gMonShinyPalette_Crocalor),
    SPECIES_PAL(SKELEDIRGE, gMonShinyPalette_Skeledirge),
    SPECIES_PAL(QUAXLY, gMonShinyPalette_Quaxly),
    SPECIES_PAL(QUAXWELL, gMonShinyPalette_Quaxwell),
    SPECIES_PAL(QUAQUAVAL, gMonShinyPalette_Quaquaval),
    SPECIES_PAL(LECHONK, gMonShinyPalette_Lechonk),
    SPECIES_PAL(OINKOLOGNE, gMonShinyPalette_Oinkologne),
    SPECIES_PAL(TAROUNTULA, gMonShinyPalette_Tarountula),
    SPECIES_PAL(SPIDOPS, gMonShinyPalette_Spidops),
    SPECIES_PAL(NYMBLE, gMonShinyPalette_Nymble),
    SPECIES_PAL(LOKIX, gMonShinyPalette_Lokix),
    SPECIES_PAL(PAWMI, gMonShinyPalette_Pawmi),
    SPECIES_PAL(PAWMO, gMonShinyPalette_Pawmo),
    SPECIES_PAL(PAWMOT, gMonShinyPalette_Pawmot),
    SPECIES_PAL(TANDEMAUS, gMonShinyPalette_Tandemaus),
    SPECIES_PAL(MAUSHOLD, gMonShinyPalette_Maushold),
    SPECIES_PAL(FIDOUGH, gMonShinyPalette_Fidough),
    SPECIES_PAL(DACHSBUN, gMonShinyPalette_Dachsbun),
    SPECIES_PAL(SMOLIV, gMonShinyPalette_Smoliv),
    SPECIES_PAL(DOLLIV, gMonShinyPalette_Dolliv),
    SPECIES_PAL(ARBOLIVA, gMonShinyPalette_Arboliva),
    SPECIES_PAL(SQUAWKABILLY, gMonShinyPalette_Squawkabilly),
    SPECIES_PAL(SQUAWKABILLY_BLUE_PLUMAGE, gMonShinyPalette_SquawkabillyBluePlumage),
    SPECIES_PAL(SQUAWKABILLY_YELLOW_PLUMAGE, gMonShinyPalette_SquawkabillyYellowPlumage),
    SPECIES_PAL(SQUAWKABILLY_WHITE_PLUMAGE, gMonShinyPalette_SquawkabillyWhitePlumage),
    SPECIES_PAL(NACLI, gMonShinyPalette_Nacli),
    SPECIES_PAL(NACLSTACK, gMonShinyPalette_Naclstack),
    SPECIES_PAL(GARGANACL, gMonShinyPalette_Garganacl),
    SPECIES_PAL(CHARCADET, gMonShinyPalette_Charcadet),
    SPECIES_PAL(ARMAROUGE, gMonShinyPalette_Armarouge),
    SPECIES_PAL(CERULEDGE, gMonShinyPalette_Ceruledge),
    SPECIES_PAL(TADBULB, gMonShinyPalette_Tadbulb),
    SPECIES_PAL(BELLIBOLT, gMonShinyPalette_Bellibolt),
    SPECIES_PAL(WATTREL, gMonShinyPalette_Wattrel),
    SPECIES_PAL(KILOWATTREL, gMonShinyPalette_Kilowattrel),
    SPECIES_PAL(MASCHIFF, gMonShinyPalette_Maschiff),
    SPECIES_PAL(MABOSSTIFF, gMonShinyPalette_Mabosstiff),
    SPECIES_PAL(SHROODLE, gMonShinyPalette_Shroodle),
    SPECIES_PAL(GRAFAIAI, gMonShinyPalette_Grafaiai),
    SPECIES_PAL(BRAMBLIN, gMonShinyPalette_Bramblin),
    SPECIES_PAL(BRAMBLEGHAST, gMonShinyPalette_Brambleghast),
    SPECIES_PAL(TOEDSCOOL, gMonShinyPalette_Toedscool),
    SPECIES_PAL(TOEDSCRUEL, gMonShinyPalette_Toedscruel),
    SPECIES_PAL(KLAWF, gMonShinyPalette_Klawf),
    SPECIES_PAL(CAPSAKID, gMonShinyPalette_Capsakid),
    SPECIES_PAL(SCOVILLAIN, gMonShinyPalette_Scovillain),
    // SPECIES_PAL(RELLOR, gMonShinyPalette_Rellor),
    // SPECIES_PAL(RABSCA, gMonShinyPalette_Rabsca),
    SPECIES_PAL(FLITTLE, gMonShinyPalette_Flittle),
    // SPECIES_PAL(ESPATHRA, gMonShinyPalette_Espathra),
    // SPECIES_PAL(TINKATINK, gMonShinyPalette_Tinkatink),
    // SPECIES_PAL(TINKATUFF, gMonShinyPalette_Tinkatuff),
    SPECIES_PAL(TINKATON, gMonShinyPalette_Tinkaton),
    SPECIES_PAL(WIGLETT, gMonShinyPalette_Wiglett),
    SPECIES_PAL(WUGTRIO, gMonShinyPalette_Wugtrio),
    SPECIES_PAL(BOMBIRDIER, gMonShinyPalette_Bombirdier),
    SPECIES_PAL(FINIZEN, gMonShinyPalette_Finizen),
    SPECIES_PAL(PALAFIN, gMonShinyPalette_Palafin),
    SPECIES_PAL(VAROOM, gMonShinyPalette_Varoom),
    SPECIES_PAL(REVAVROOM, gMonShinyPalette_Revavroom),
    SPECIES_PAL(CYCLIZAR, gMonShinyPalette_Cyclizar),
    SPECIES_PAL(ORTHWORM, gMonShinyPalette_Orthworm),
    SPECIES_PAL(GLIMMET, gMonShinyPalette_Glimmet),
    SPECIES_PAL(GLIMMORA, gMonShinyPalette_Glimmora),
    SPECIES_PAL(GREAVARD, gMonShinyPalette_Greavard),
    SPECIES_PAL(HOUNDSTONE, gMonShinyPalette_Houndstone),
    SPECIES_PAL(FLAMIGO, gMonShinyPalette_Flamigo),
    SPECIES_PAL(CETODDLE, gMonShinyPalette_Cetoddle),
    SPECIES_PAL(CETITAN, gMonShinyPalette_Cetitan),
    SPECIES_PAL(VELUZA, gMonShinyPalette_Veluza),
    SPECIES_PAL(DONDOZO, gMonShinyPalette_Dondozo),
    SPECIES_PAL(TATSUGIRI, gMonShinyPalette_TatsugiriCurly),
    SPECIES_PAL(TATSUGIRI_DROOPY, gMonShinyPalette_TatsugiriDroopy),
    SPECIES_PAL(TATSUGIRI_STRETCHY, gMonShinyPalette_TatsugiriStretchy),
    SPECIES_PAL(ANNIHILAPE, gMonShinyPalette_Annihilape),
    SPECIES_PAL(CLODSIRE, gMonShinyPalette_Clodsire),
    SPECIES_PAL(FARIGIRAF, gMonShinyPalette_Farigiraf),
    SPECIES_PAL(DUDUNSPARCE, gMonShinyPalette_Dudunsparce),
    SPECIES_PAL(KINGAMBIT, gMonShinyPalette_Kingambit),
    SPECIES_PAL(GREAT_TUSK, gMonShinyPalette_GreatTusk),
    SPECIES_PAL(SCREAM_TAIL, gMonShinyPalette_ScreamTail),
    SPECIES_PAL(BRUTE_BONNET, gMonShinyPalette_BruteBonnet),
    SPECIES_PAL(FLUTTER_MANE, gMonShinyPalette_FlutterMane),
    SPECIES_PAL(SLITHER_WING, gMonShinyPalette_SlitherWing),
    SPECIES_PAL(SANDY_SHOCKS, gMonShinyPalette_SandyShocks),
    SPECIES_PAL(IRON_TREADS, gMonShinyPalette_IronTreads),
    SPECIES_PAL(IRON_BUNDLE, gMonShinyPalette_IronBundle),
    SPECIES_PAL(IRON_HANDS, gMonShinyPalette_IronHands),
    SPECIES_PAL(IRON_JUGULIS, gMonShinyPalette_IronJugulis),
    SPECIES_PAL(IRON_MOTH, gMonShinyPalette_IronMoth),
    SPECIES_PAL(IRON_THORNS, gMonShinyPalette_IronThorns),
    SPECIES_PAL(FRIGIBAX, gMonShinyPalette_Frigibax),
    SPECIES_PAL(ARCTIBAX, gMonShinyPalette_Arctibax),
    SPECIES_PAL(BAXCALIBUR, gMonShinyPalette_Baxcalibur),
    SPECIES_PAL(GIMMIGHOUL, gMonShinyPalette_Gimmighoul),
    // SPECIES_PAL(GHOLDENGO, gMonShinyPalette_Gholdengo),
    SPECIES_PAL(WO_CHIEN, gMonShinyPalette_WoChien),
    SPECIES_PAL(CHIEN_PAO, gMonShinyPalette_ChienPao),
    SPECIES_PAL(TING_LU, gMonShinyPalette_TingLu),
    SPECIES_PAL(CHI_YU, gMonShinyPalette_ChiYu),
    // SPECIES_PAL(ROARING_MOON, gMonShinyPalette_RoaringMoon),
    SPECIES_PAL(IRON_VALIANT, gMonShinyPalette_IronValiant),
    SPECIES_PAL(KORAIDON, gMonShinyPalette_Koraidon),
    SPECIES_PAL(MIRAIDON, gMonShinyPalette_Miraidon),
    SPECIES_PAL(WALKING_WAKE, gMonShinyPalette_WalkingWake),
    SPECIES_PAL(IRON_LEAVES, gMonShinyPalette_IronLeaves),
#endif
